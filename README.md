...
Using the typedeclaration gives you following advantages:
 - Codecompletion for arcgoose library
 - Typed Features, so typecheck will fail when you try access attributes which do not exist in your service
